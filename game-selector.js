...
(function() {
  ...
  // Boost la saturation d'une couleur hex (HSL → S * factor → hex). Utilisé
  // pour rendre la teinte dominante extraite (souvent terne car c'est une
  // moyenne pondérée) plus vibrante avant de l'utiliser comme fond du pill.
